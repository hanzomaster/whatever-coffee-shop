...
<svelte:head>
	<title>New Product - Admin - Coffee Shop</title>
</svelte:head>
...
<div class="mx-auto max-w-2xl space-y-6">
	<div>
		...
		<h2 class="mt-2 text-2xl font-bold text-coffee-900">Add New Product</h2>
		<p class="text-coffee-600">Create a new product in your catalog</p>
	</div>
