...
export class Migration1648055040801 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "customer" ("id" SERIAL NOT NULL, "first_name" character varying(20) NOT NULL, "last_name" character varying(20) NOT NULL, "balance" numeric(10,2) NOT NULL, "phone" character varying NOT NULL, CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "order_detail" ("id" SERIAL NOT NULL, "unit_price" numeric(10,2), "quantity" numeric(10,0), "orderId" integer NOT NULL, "productId" integer NOT NULL, "storeId" integer NOT NULL, CONSTRAINT "PK_0afbab1fa98e2fb0be8e74f6b38" PRIMARY KEY ("id"))`);
